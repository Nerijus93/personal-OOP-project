...
public class DonationScreen extends javax.swing.JFrame {
    ...
    public DonationScreen(HomeScreen inParent) {
        ...
        // When user clicks the window X don't exit the application
        // Instead return to the HomeScreen
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        // Create Donor and Donation object
        ...
        // Inform the user and clear fields
    ...
    private void goBackToHome() {
        this.dispose();       // close DonationScreen
        parent.setVisible(true);  // show HomeScreen again
    }
